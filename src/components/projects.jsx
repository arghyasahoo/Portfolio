                ...
                <div id="projects" className='container-fluid'>
                    ...
                    <div className="container-fluid projects">
                        <div className="row container-fluid">
                            <div class="col-md-3 gifs-left m-1">
                                <img src={process.env.PUBLIC_URL + 'img/chat.gif'}></img>
                            </div>
                            <div class="col-md-8 desc rightpr m-1">
                                <h3>ChatBOX</h3>
                        ...
                        <div className="row container-fluid">
                            ...
                            <div class="col-md-3 gifs-right m-1">
                                <img src={process.env.PUBLIC_URL + 'img/attendance.gif'}></img>
                            </div>
                        </div>
                        <div className="row container-fluid">
                            <div id="tic-tac-toe" class="col-md-3 gifs-left m-1">
